...
class Homuncul : public Human {
public:
	Homuncul() {}
	Homuncul(string name) : Human(name) {}
	Homuncul(string name, string area) : Human(name, area) {}
	Homuncul(string name, string area, string food) : Human(name, area, food) {}
};
